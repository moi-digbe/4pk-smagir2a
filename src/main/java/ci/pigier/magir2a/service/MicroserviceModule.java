package ci.pigier.magir2a.service;

import ci.pigier.magir2a.account.LocalAccount;
import ci.pigier.magir2a.account.LocalAccountProviderImpl;
import ci.pigier.magir2a.cache.RemoteAccountCache;
import ci.pigier.magir2a.guice.EntityRegistrarModule;
